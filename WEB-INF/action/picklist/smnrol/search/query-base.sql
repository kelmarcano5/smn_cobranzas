select
  ...
  smn_base.smn_v_usuarios.usr_nombres ||' - '|| smn_base.smn_v_usuarios.usr_apellidos as smn_usuario_rf,
    ...
    smn_base.smn_estructura_organizacional.eor_codigo ||' - '|| smn_base.smn_estructura_organizacional.eor_nombre as rol_posicion_estructura_rf,
...
from
   smn_cobranzas.smn_rol
    ...
    left outer join smn_base.smn_estructura_organizacional on smn_base.smn_estructura_organizacional.smn_estructura_organizacional_id = smn_cobranzas.smn_rol.rol_posicion_estructura_rf
