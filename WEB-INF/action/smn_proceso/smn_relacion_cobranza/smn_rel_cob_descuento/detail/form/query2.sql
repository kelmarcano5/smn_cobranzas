...
INNER JOIN
	smn_cobranzas.smn_rel_cob_descuento ON smn_cobranzas.smn_rel_cob_descuento.smn_relacion_cobranza_id=smn_cobranzas.smn_relacion_cobranza.smn_relacion_cobranza_id
WHERE
