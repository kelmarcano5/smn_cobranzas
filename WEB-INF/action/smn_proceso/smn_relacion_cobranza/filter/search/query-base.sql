select
	...
	when smn_cobranzas.smn_relacion_cobranza.rco_estatus_proceso='CO' then '${lbl:b_reconciled}'
	end as rco_estatus_proceso_combo,
	...
	smn_base.smn_formas_pago.fop_descripcion AS smn_forma_pago_rf_combo,
	smn_cobranzas.smn_relacion_cobranza.rco_monto_neto_cob_ml,
	smn_cobranzas.smn_relacion_cobranza.rco_monto_neto_cob_ma,
	smn_cobranzas.smn_relacion_cobranza.rco_monto_documento_ml,
	smn_cobranzas.smn_relacion_cobranza.rco_monto_documento_ma
from
	...
	left join smn_base.smn_documentos_generales on smn_base.smn_documentos_generales.smn_documentos_generales_id = smn_cobranzas.smn_relacion_cobranza.smn_doc_orig_rf
	INNER JOIN smn_base.smn_formas_pago ON smn_base.smn_formas_pago.smn_formas_pago_id=smn_cobranzas.smn_relacion_cobranza.smn_forma_pago_rf
where
	smn_relacion_cobranza_id is not null
	and 	smn_cobranzas.smn_documento.smn_documento_id=smn_cobranzas.smn_relacion_cobranza.smn_documento_id
	${filter}
order by
