...
INNER JOIN smn_caja.smn_mov_caja_cabecera ON smn_comercial.smn_pedido_cabecera.smn_mov_caja_cabecera_id = smn_caja.smn_mov_caja_cabecera.smn_mov_caja_cabecera_id
...
smn_cobranzas.smn_relacion_envio_cobranza.smn_cliente_rf = ${fld:idcliente} AND*/