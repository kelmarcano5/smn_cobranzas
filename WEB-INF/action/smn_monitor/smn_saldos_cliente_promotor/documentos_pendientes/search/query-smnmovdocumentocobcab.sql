select
	...
	end as mdc_estatus_financiero_combo,
...
FROM 
	...
	LEFT JOIN smn_base.smn_documentos_generales ON smn_base.smn_documentos_generales.smn_documentos_generales_id = smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_rf
	...
	INNER JOIN smn_cobranzas.smn_documento ON smn_cobranzas.smn_documento.smn_documento_id=smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_rf
	left join smn_base.smn_auxiliar promo on promo.smn_auxiliar_id = smn_cobranzas.smn_mov_documento_cob_cab.smn_promotor_rf
WHERE
	smn_cobranzas.smn_mov_documento_cob_cab.smn_cliente_rf=${fld:smn_cliente_rf}
	AND
	smn_cobranzas.smn_mov_documento_cob_cab.mdc_estatus_financiero='PE'