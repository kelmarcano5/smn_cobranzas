SELECT 
    ...
    smn_cobranzas.smn_documento.doc_usa_moneda_alterna AS cfc_uma,
    ...
    smn_cobranzas.smn_mov_documento_cob_detalle.mdd_saldo_ml AS cfc_monto,
...
where
    smn_cobranzas.smn_mov_documento_cob_detalle.smn_mov_documento_cob_cab_id = ${fld:id2}
    AND
