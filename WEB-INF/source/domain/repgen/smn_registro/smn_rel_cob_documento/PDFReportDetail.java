package domain.repgen.smn_registro.smn_rel_cob_documento;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_mov_documento_cob_det_id_name");
			if (d != null)
			{
			name  = "b_mov_documento_cob_det_id";
			label = "${lbl:b_mov_documento_cob_det_id}";
		...
		d = rs.getString("smn_mov_documento_cob_det_id");
			if (d != null)
			{
			name  = "b_mov_documento_cob_det_id";
			label = "${lbl:b_mov_documento_cob_det_id}";
